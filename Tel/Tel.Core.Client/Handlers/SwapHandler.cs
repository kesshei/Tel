...
namespace Tel.Core.Handlers.Client
{
    public class SwapHandler : IClientHandler
    {
        ...
        private async Task swap(TelClient cleint, string requestId, string address, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async Task<Stream> createRemote(string requestId, TelClient cleint, CancellationToken cancellationToken)
        {
